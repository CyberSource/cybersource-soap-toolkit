...
cybsdemo:	sample.cpp $(SOAPH) $(SOAPCPP) ../gsoap/dom.cpp wsseapi.o smdevp.o
		$(CPP) $(CFLAGS) -o cybsdemo sample.cpp soapC.o ../gsoap/dom.cpp stdsoap2.o struct_timeval.o threads.o mecevp.o wsaapi.o wsseapi.o smdevp.o soapITransactionProcessorProxy.o gsoapWinInet.o propertiesUtil.o binarySecurityTokenHandler.o
